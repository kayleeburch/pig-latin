...
console.log(pig.translate("quick quick") === "ickquay ickquay");
...
console.log("translates capital words:");
console.log(pig.translate("The") === "Ethay");
console.log("translates capital multiple words:");
console.log(pig.translate("The Quick Brown Fox") === "Ethay Ickquay Ownbray Oxfay");
// console.log("translates punctuation multiple words:");
// console.log(pig.translate("The Quick Brown Fox!") === "Ethay Ickquay-Ownbray Oxfay!");
// console.log("translates punctuation on single word:");
// console.log(pig.translate("quiet!") === "ietquay!");
